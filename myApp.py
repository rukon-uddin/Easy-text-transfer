...
socketio = SocketIO(app, logger=True, cors_allowed_origins="https://easytt.rukonu.com")
...
def message_recieved(data):
    emit('message_from_server', {'text': data['text'],'room': data['room']}, broadcast=True)
...
if __name__ == "__main__":
    ...
    socketio.run(app, host="0.0.0.0", port=5000, debug=True, ssl_context=("/etc/letsencrypt/live/easytt.rukonu.com/cert.pem", "/etc/letsencrypt/live/easytt.rukonu.com/privkey.pem"))
